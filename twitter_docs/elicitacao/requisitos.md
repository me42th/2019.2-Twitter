...
|Código| Requisito | Rastro | MoSCoW | Tipo |
|------|-----------|--------|--------|------|
| R001 |	O usuário deve ser capaz de retweetar, ou seja, copiar o tweet para o seu próprio perfil. |	Entrevista 02 do Fernando, Entrevista da Aline |	MUST |	F |
| R002 |	Liberdade para o usuário postar o que quiser. - censura parcial. |	Entrevista do Erick, Entrevista da Aline, Entrevista do Erick |	SHOULD |	NF |
| R003 |	Rapidez na realização de tarefas. |	Entrevista do Erick, Entrevista 01 do Fernando, Entrevista da Aline |	COULD |	NF |
| R004 |	Permitir a interação da aplicação com outros aplicativos. |	Entrevista do Erick |	WOULD |	F |
| R005 |	Segurança e proteção de dados. |	Entrevista do Erick, Entrevista da Lorrany |	MUST |	F |
| R006 |	Permitir a troca de informações entre usuários - numero comentarios, chats, retweet. |	Entrevista do Erick |	MUST |	F |
| R007 |	Ter um espaço destinado a anúncios. |	Entrevista do Erick |	COULD |	F |
...
| R021 |	"Liberdade do usuário em relação aos anúncios promovidos pela plataforma." |	Entrevista 01 Bruno |	SHOULD |	NF |
| R022 |	Filtragem ou limitação de conteúdo. |	Entrevista 01 Bruno |	COULD |	F |
| R023 |	Permitir postagem de conteúdo curto para redirecionamento para outros links. |	Entrevista 02 Eugênio |	SHOULD |	F |
| R024 |	Permitir Tweets curtos como um diário pessoal sem necessariamente ter imagens. |	Entrevista 02 Eugênio |	MUST |	F |
| R025 |	O usuário deve ser capaz de buscar informações em um campo de pesquisa. |	Entrevista da Aline |	MUST |	F |
| R026 |	O usuário deve ser capaz de seguir outros usuários. |	Entrevista da Aline |	MUST |	F |
...
| R034 |	O usuário deve ser capaz de criar uma sequência de tweets. |	Entrevista da Aline |	MUST |	F |
